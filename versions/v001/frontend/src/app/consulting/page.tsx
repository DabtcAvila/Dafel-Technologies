...
const ConsultingPage = memo(function ConsultingPage() {
    ...
    <>
          ...
          <div className="flex h-[70px] items-center">
            <div className="flex items-center flex-1">
              <svg 
                ...
                aria-label="Dafel Consulting Logo"
              >
                <path 
              ...
              <span className="text-2xl font-sans font-semibold tracking-tight" style={{ color: '#0d457f' }}>
                Dafel Consulting
              </span>
            </div>
      ...
      <section className="relative min-h-screen hero-gradient">
        <div className="mx-auto max-w-7xl px-6 pt-32 pb-24 lg:px-8 lg:pt-40">
          ...
          >
            <motion.h1
              className="text-5xl font-mono font-light tracking-wider sm:text-6xl lg:text-7xl"
              style={{ color: '#0d457f' }}
              variants={fadeIn}
            >
              Servicios Actuariales.
              <span className="block font-mono font-normal tracking-wider text-gray-900">Precisión Absoluta.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              variants={fadeIn}
            >
              Transformamos análisis actuariales complejos en decisiones exactas. Nuestros expertos combinan metodología tradicional con IA para eliminar errores en valuaciones que requieren precisión absoluta.
            </motion.p>
            ...
            >
              <button 
                onClick={() => router.push('/login?callbackUrl=/studio&source=consulting')}
                className="group relative overflow-hidden rounded-lg text-white px-32 py-4 text-lg font-medium transition-all hover:opacity-90 shadow-lg"
                style={{ backgroundColor: '#0d457f' }}>
                <span className="relative z-10">Acceder a Dafel Studio</span>
              </button>
            </motion.div>
          </motion.div>
            ...
            <div className="max-w-xl">
              ...
              >
                <h2 className="text-5xl lg:text-6xl leading-tight">
                  <span className="font-light">Valuaciones</span>
                  <br />
                  <span className="font-semibold" style={{ color: '#0d457f' }}>Actuariales</span>
                </h2>
                <p className="mt-8 text-xl lg:text-2xl text-gray-600 leading-relaxed">
                  Especialistas en NIF D-3, IFRS-19 y USGAAP con análisis IA para mayor precisión y eficiencia.
                </p>
                <button 
                  onClick={() => router.push('/login?callbackUrl=/studio&source=consulting')}
                  className="mt-10 text-white px-10 py-4 rounded-lg font-medium text-base transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2"
                  style={{ backgroundColor: '#0d457f' }}>
                      ...
                      <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="relative w-32 h-32">
                          <svg viewBox="0 0 120 120" className="w-full h-full">
                            {/* Nodes */}
                            <circle cx="30" cy="40" r="8" fill="none" stroke="#0d457f" strokeWidth="2"/>
                            <circle cx="60" cy="20" r="8" fill="none" stroke="#0d457f" strokeWidth="2"/>
                            <circle cx="90" cy="35" r="8" fill="none" stroke="#0d457f" strokeWidth="2"/>
                            ...
                            {/* Connections */}
                            <line x1="30" y1="40" x2="60" y2="20" stroke="#0d457f" strokeWidth="1" opacity="0.4"/>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-mono font-light tracking-wider sm:text-4xl" style={{ color: '#0d457f' }}>
              Servicios Especializados
            </h2>
            <p className="mt-4 text-lg font-sans text-gray-600">
              Metodología actuarial probada potenciada con tecnología IA para resultados superiores
            </p>
          </motion.div>
          ...
          >
            <motion.div
              ...
              variants={fadeIn}
            >
              <div className="mb-4 h-px w-12" style={{ backgroundColor: '#0d457f' }} />
              ...
              <p className="mt-4 text-sm font-sans leading-relaxed text-gray-600">
                Análisis de obligaciones laborales bajo normativa mexicana con algoritmos IA que optimizan cálculos de prima de antigüedad, PTU y beneficios post-empleo.
              </p>
              <button className="mt-6 text-sm font-medium transition-colors" style={{ color: '#0d457f' }}>
                Más información →
              </button>
            </motion.div>
            ...
            >
              ...
              <p className="mt-4 text-sm font-sans leading-relaxed text-gray-600">
                Compliance internacional con estándares IFRS-19 usando machine learning para identificar patrones en beneficios a empleados y optimizar proyecciones.
              </p>
              <button className="mt-6 text-sm font-medium transition-colors" style={{ color: '#0d457f' }}>
                Más información →
              </button>
            ...
            >
              ...
              <p className="mt-4 text-sm font-sans leading-relaxed text-gray-600">
                Principios contables estadounidenses con validación IA que asegura cumplimiento total y genera reportes automáticos para operaciones cross-border.
              </p>
              <button className="mt-6 text-sm font-medium transition-colors" style={{ color: '#0d457f' }}>
                Más información →
              </button>
      ...
      <section className="bg-white py-24">
        ...
        >
          <h2 className="text-3xl font-mono font-light tracking-wider text-gray-900">
            ¿Listo para la siguiente evolución?
          </h2>
          <p className="mt-4 text-lg text-gray-600">
            Migra gradualmente de consultoría tradicional a autonomía total con Dafel Studio
          </p>
          <div className="mt-8 flex gap-4 justify-center">
            ...
            <button 
              onClick={() => router.push('/login?callbackUrl=/studio&source=consulting')}
              className="rounded-lg border-2 px-8 py-3 text-sm font-medium transition-all hover:text-white"
              style={{ borderColor: '#0d457f', color: '#0d457f' }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0d457f'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
            >
              Explorar Dafel Studio →
            </button>
          </div>
        </motion.div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="flex flex-col items-center sm:items-start">
              <span className="text-lg font-sans font-semibold" style={{ color: '#0d457f' }}>
                Dafel Consulting
              </span>
